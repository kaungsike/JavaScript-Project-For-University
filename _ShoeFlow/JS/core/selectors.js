...
// Animate
export const headerLines = document.querySelectorAll(`[animation="left_to_right"]`)
export const headerLines_ = document.querySelectorAll(`[animation="left_to_right_"]`)