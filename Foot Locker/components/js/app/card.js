...
export const createProductCard = (data) => {
  ...
  template
    .querySelector(".body")
    .setAttribute("href", "../pages/productDetail.html#" + data.id + "#0");
  template
    .querySelector(".forFooter")
    .setAttribute("href", "../pages/productDetail.html#" + data.id + "#0");
...
export const handleProductCardMinImg = (e) => {
  if (e.target.classList.contains("min-img")) {
    ...
    card
      ...
      .setAttribute(
        "href",
        "../pages/productDetail.html#" +
          card.getAttribute("index") +
          "#" +
          e.target.closest(".min-img").getAttribute("index")
      );
    card
      .querySelector(".forFooter")
      .setAttribute(
...
export const handleProfile = (e) => {
  if (e.target.classList.contains("profileClick")) {
    document.querySelector("#logout").classList.toggle("display");
  }
};

export const handleLogOut = (e) => {
  if (e.target.classList.contains("logout")) {
    if (confirm("Are you sere you want to logout?")) {
      localStorage.clear()
